...
internal class SPLTokenRepositoryImpl @Inject constructor(
    ...
    private fun processRawSPLAddress(res: JsonElement): SPLAddressResponse {
        ...
        val tokenAmount = info.getAsJsonObject("tokenAmount")
        val uiAmountString = tokenAmount.getAsJsonPrimitive("uiAmountString").asString
        return SPLAddressResponse(mint, uiAmountString)
    }
}
