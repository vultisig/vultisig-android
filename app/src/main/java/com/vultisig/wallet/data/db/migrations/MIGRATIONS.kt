...
// rows and dependent id references to the same key before repository operations read them back. If
// a corrected row somehow already exists, drop the legacy duplicate first so the update cannot trip
// the coin PK.
