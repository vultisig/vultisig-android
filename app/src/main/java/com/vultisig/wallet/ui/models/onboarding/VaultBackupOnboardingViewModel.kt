        ...
        val FastVaultBackupOnboardingTips =
            listOf(
                VaultBackupOnboardingTip(
                    ...
                    description =
                        UiText.StringResource(R.string.backup_device_backup_and_password_are_key),
                    logo = R.drawable.arrow_cloude,
                ),
                VaultBackupOnboardingTip(
                    title = UiText.StringResource(R.string.backup_store_backups_separately),
                    description =
                        UiText.StringResource(R.string.backup_keep_each_backup_in_different_place),
                    logo = R.drawable.branches,
                ),
            )

        fun secureVaultBackupOnboardingTips(deviceCount: Int) =
            listOf(
                VaultBackupOnboardingTip(
                ...
                VaultBackupOnboardingTip(
                    ...
                    description =
                        UiText.StringResource(
                            R.string.vault_setup_save_each_backup_in_a_different_cloud_service
                        ),
                    logo = R.drawable.branches,
                ),
            )
