...
@HiltViewModel
internal class BiometricsEnableViewModel
@Inject
constructor(
    ...
    private val vaultId: String = savedStateHandle.toRoute<Route.BiometricsEnable>().vaultId
    ...
    fun onCheckChange(isChecked: Boolean) =
        viewModelScope.launch { uiModel.update { it.copy(isSwitchEnabled = isChecked) } }
