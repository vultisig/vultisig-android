...
import com.vultisig.wallet.ui.models.ScanQrTokenAddressViewModel
...
@Composable
internal fun ScanQrTokenAddress(
    navController: NavController,
    viewModel: ScanQrTokenAddressViewModel = hiltViewModel(),
) {
    ScanQrScreen(
        navController = navController,
        onScanSuccess = viewModel::navigateToBack,
    )
}
