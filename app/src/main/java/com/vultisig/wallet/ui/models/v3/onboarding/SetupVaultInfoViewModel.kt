...
@HiltViewModel
internal class SetupVaultInfoViewModel
@Inject
            ...
            listOf(
                ...
                SetupVaultInfoTip(
                    ...
                    UiText.StringResource(
                        R.string.vault_setup_perfect_for_users_with_only_2_devices
                    ),
                ),
            )
        private val Tips_3_Device =
            listOf(
                SetupVaultInfoTip(
                    R.drawable.signing,
                    UiText.StringResource(R.string.vault_setup_2_device_signing),
