...
internal fun SwapScreen(
    ...
    Scaffold(
        ...
        topBar = {
            VsTopAppBar(
                title = stringResource(R.string.swap_screen_swap),
                ...
                Box {
                    Column(
                        ...
                        TokenInput(
                            ...
                            title = stringResource(R.string.swap_form_from),
                        ...
                        TokenInput(
                            title = stringResource(R.string.swap_form_to),
                            isLoading = state.isLoading,
    ...
    Column(
        ...
        Row(
            ...
            Column(
                ...
                if (isLoading && title == stringResource(R.string.swap_form_to)) {
                    UiPlaceholderLoader(
                        modifier = Modifier
                            .height(24.dp)
                            .width(150.dp)
