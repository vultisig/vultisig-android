...
import com.vultisig.wallet.ui.screens.keygen.VerifyExistingVaultScreen
...
internal fun SetupNavGraph(navController: NavHostController, startDestination: Any) {
    NavHost(
        ...
        composable<Route.TonLiquidStake> {
            com.vultisig.wallet.ui.screens.v2.defi.ton.TonLiquidStakeScreen()
        }

        composable<Route.TonLiquidUnstake> {
            com.vultisig.wallet.ui.screens.v2.defi.ton.TonLiquidUnstakeScreen()
        }
        ...
        composable<Route.VerifyExistingVault> { VerifyExistingVaultScreen() }
        ...
        composable<Route.QuantumSecurityIntro> { QuantumSecurityIntroScreen() }
