...
internal class FolderRepositoryImpl @Inject constructor(private val folderDao: FolderDao) :
    FolderRepository {
    override suspend fun getFolder(id: String): Folder = folderDao.getFolder(id).toFolder()
    ...
    private fun FolderEntity.toFolder() = Folder(id = id, name = name)
}
