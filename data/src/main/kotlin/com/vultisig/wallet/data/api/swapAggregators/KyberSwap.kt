...
class KyberSwap(private val vaultHexPublicKey: String, private val vaultHexChainCode: String) {
    ...
    fun getSignedTransaction(
        ...
        return EvmHelper(keysignPayload.coin.coinType, vaultHexPublicKey, vaultHexChainCode)
            .getSignedTransaction(inputData, signatures)
    }

    fun getPreSignedInputData(
        quote: KyberSwapQuoteJson,
        keysignPayload: KeysignPayload,
        nonceIncrement: BigInteger,
    ): ByteArray {
        val input =
