...
@Serializable data class JupiterSwapQuoteError(@SerialName("error") val error: String)
...
data class RoutePlanItemJson(
    @SerialName("swapInfo") val swapInfo: SwapInfoJson,
    @SerialName("percent") val percent: Int,
)

@Serializable
data class SwapInfoJson(
    @SerialName("ammKey") val ammKey: String,
