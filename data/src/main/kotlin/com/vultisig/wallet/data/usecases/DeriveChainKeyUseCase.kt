...
data class ChainKeyResult(val chain: Chain, val privateKeyHex: String, val isEddsa: Boolean) {
    override fun toString(): String = "ChainKeyResult(chain=${chain.raw}, ***)"
}

fun interface DeriveChainKeyUseCase {
    operator fun invoke(mnemonic: String, chainSetting: ChainImportSetting): ChainKeyResult
}

internal class DeriveChainKeyUseCaseImpl @Inject constructor() : DeriveChainKeyUseCase {

    override fun invoke(mnemonic: String, chainSetting: ChainImportSetting): ChainKeyResult {
        ...
        return ChainKeyResult(chain = chain, privateKeyHex = privateKeyHex, isEddsa = isEddsa)
    }
}
