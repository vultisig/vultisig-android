...
internal interface ApiModule {
    ...
    @Binds @Singleton fun bindOneInchApi(impl: OneInchApiImpl): OneInchApi

    @Binds @Singleton fun bindVultiSignerApi(impl: VultiSignerApiImpl): VultiSignerApi
    ...
    @Binds @Singleton fun bindMarketWidgetApi(impl: MarketWidgetApiImpl): MarketWidgetApi

    @Binds @Singleton fun bindThorChainApi(impl: ThorChainApiImpl): ThorChainApi

    @Binds @Singleton fun bindMayaChainApi(impl: MayaChainApiImp): MayaChainApi
    ...
    @Binds @Singleton fun bindRouterApi(impl: RouterApiImp): RouterApi
