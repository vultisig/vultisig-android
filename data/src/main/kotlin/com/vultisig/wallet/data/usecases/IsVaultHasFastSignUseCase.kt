 ...
 *
 * If the vault already supports fast signing structurally, we return true. Otherwise, we check with
 * the backend to see if a fast-sign record exists.
 */
internal class IsVaultHasFastSignUseCaseImpl
@Inject
constructor(private val repository: VultiSignerRepository) : IsVaultHasFastSignUseCase {
