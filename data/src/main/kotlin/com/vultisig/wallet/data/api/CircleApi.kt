...
internal class CircleApiImpl @Inject constructor(private val httpClient: HttpClient) : CircleApi {
    ...
    override suspend fun createScAccount(owner: String): String {
        ...
        return httpClient
            .post(CIRCLE_URL) {
                ...
                url { appendPathSegments("/create") }
                setBody(CreateWalletJson(owner = owner, key = requestId))
            }
            .bodyOrThrow<JsonPrimitive>()
            .content
    }
...
internal data class CreateWalletJson(
    @SerialName("name") val name: String = "Vultisig Wallet",
    @SerialName("owner") val owner: String = "",
    @SerialName("account_type") val accountType: String = "SCA",
    @SerialName("idempotency_key") val key: String = "",
)
