...
data class TxStatusConfiguration(val pollIntervalSeconds: Long, val maxWaitSeconds: Long)
...
internal class TxStatusConfigurationProviderImpl @Inject constructor() :
    TxStatusConfigurationProvider {

    private val txStatusConfigs =
        mapOf(
