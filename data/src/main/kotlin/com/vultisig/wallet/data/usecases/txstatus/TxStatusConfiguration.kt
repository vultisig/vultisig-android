...
internal class TxStatusConfigurationProviderImpl @Inject constructor() : TxStatusConfigurationProvider {
    ...
    private val txStatusConfigs = mapOf(
        Chain.Ethereum to TxStatusConfiguration(5, 10 * 60),
        Chain.Polygon to TxStatusConfiguration(5, 10 * 60),
        Chain.Arbitrum to TxStatusConfiguration(5, 10 * 60),
        Chain.Base to TxStatusConfiguration(5, 10 * 60),
        Chain.Avalanche to TxStatusConfiguration(5, 10 * 60),
        Chain.CronosChain to TxStatusConfiguration(5, 10 * 60),
        Chain.BscChain to TxStatusConfiguration(5, 10 * 60),
        Chain.Blast to TxStatusConfiguration(5, 10 * 60),
        Chain.Optimism to TxStatusConfiguration(5, 10 * 60),
        Chain.ZkSync to TxStatusConfiguration(5, 10 * 60),
        Chain.Mantle to TxStatusConfiguration(5, 10 * 60),
        Chain.Sei to TxStatusConfiguration(5, 10 * 60),
        Chain.Hyperliquid to TxStatusConfiguration(5, 10 * 60),
