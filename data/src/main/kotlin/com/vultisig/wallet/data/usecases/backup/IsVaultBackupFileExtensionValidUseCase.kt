...
class IsVaultBackupFileExtensionValidUseCaseImpl
@Inject
    ...
    override suspend operator fun invoke(uri: Uri, mimeType: MimeType): Boolean {
        ...
        return when (mimeType) {
            MimeType.OCTET_STREAM -> {
                FILE_ALLOWED_EXTENSIONS.any { it.equals(file.extension, ignoreCase = true) }
            }

            MimeType.ZIP -> file.extension.equals("zip", ignoreCase = true)
        }
    }
}
