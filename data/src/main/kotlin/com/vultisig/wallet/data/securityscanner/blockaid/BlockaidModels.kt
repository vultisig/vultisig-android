...
data class SolanaScanTransactionRequestJson(
    ...
    @SerialName("metadata") val metadata: CommonMetadataJson,
...
data class EthereumScanTransactionRequestJson(
    ...
    @SerialName("simulate_with_estimated_gas") val simulatedWithEstimatedGas: Boolean = false,
) {
...
data class BlockaidTransactionScanResponseJson(
    ...
    @SerialName("validation") val validation: BlockaidValidationJson?,
    @SerialName("result") val result: BlockaidSolanaResultJson?,
    @SerialName("error") val error: String?,
) {
    @Serializable
    data class BlockaidSolanaResultJson(
        @SerialName("validation") val validation: BlockaidSolanaValidationJson
    ) {
        @Serializable
    ...
    data class BlockaidValidationJson(
        ...
        @SerialName("description") val description: String?,
        @SerialName("reason") val reason: String?,
        @SerialName("features") val features: List<BlockaidFeatureJson>?,
        @SerialName("error") val error: String?,
    ) {
        @Serializable
