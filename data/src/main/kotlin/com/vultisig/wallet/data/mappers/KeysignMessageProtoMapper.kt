...
internal class KeysignMessageFromProtoMapperImpl
@Inject
constructor(private val mapKeysignPayload: KeysignPayloadProtoMapper) :
    KeysignMessageFromProtoMapper {

    override suspend fun invoke(from: KeysignMessageProto): KeysignMessage =
        KeysignMessage(
