        ...
        flow {
                try {
                    val details = supervisorScope {
                        ...
                        val maturityDeferred = async { getCacaoUnstakeMaturity(address) }
                        ...
                        MayaCacaoStakingDetails(
                            ...
                            apr = apr,
                            canUnstake = hasPosition && maturity is CacaoUnstakeMaturity.Mature,
                            unstakeUnlocksInSeconds =
                                if (hasPosition && maturity is CacaoUnstakeMaturity.Locked)
