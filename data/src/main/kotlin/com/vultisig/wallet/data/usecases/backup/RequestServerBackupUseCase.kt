...
/**
 * Requests the VultiSigner server to resend the encrypted vault backup share
 * to the specified email address. Resolves the vault's ECDSA public key
 * from [VaultRepository] and delegates to [VultiSignerRepository].
 */
...
internal class RequestServerBackupUseCaseImpl @Inject constructor(
