...
internal interface RepositoriesModule {
    ...
    @Binds
    @Singleton
    fun bindMayachainBondRepository(impl: MayachainBondRepositoryImpl): MayachainBondRepository
    ...
    @Binds
    @Singleton
    fun bindContractAbiRepository(impl: ContractAbiRepositoryImpl): ContractAbiRepository
    ...
    // Injected into SwapKitQuoteSource as the client-side enablement gate: since the provider table
    // stopped allowlisting chains, this cache is what decides which pairs are worth a /v3/quote.
    @Binds
    @Singleton
