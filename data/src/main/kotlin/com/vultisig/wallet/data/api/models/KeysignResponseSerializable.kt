...
data class KeysignResponseSerializable(
    ...
    @SerialName("DerSignature") val derSignature: String,
    @SerialName("RecoveryID") val recoveryID: String,
) {
    fun toOriginal() =
        tss.KeysignResponse().apply {
    ...
    companion object {
        fun serialize(response: tss.KeysignResponse) =
            KeysignResponseSerializable(
                msg = response.msg,
                r = response.r,
                s = response.s,
