...
data class KyberSwapQuoteData(
    @SerialName("amountIn") val amountIn: String,
    @SerialName("amountInUsd") val amountInUsd: String,
    @SerialName("amountOut") val amountOut: String,
    @SerialName("amountOutUsd") val amountOutUsd: String,
    @SerialName("gas") val gas: String?,
    @SerialName("gasUsd") val gasUsd: String,
    @SerialName("data") val data: String,
    @SerialName("routerAddress") val routerAddress: String,
    @SerialName("transactionValue") val transactionValue: String,
    // not in response
    @kotlinx.serialization.Transient val gasPrice: String? = "",
    @kotlinx.serialization.Transient val fee: BigInteger? = BigInteger.ZERO,
)
