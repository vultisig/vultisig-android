...
class ThorchainSwapHelper {
    ...
    fun getSwapPreSignedInputData(keysignPayload: KeysignPayload): ByteArray {
        val thorchainData =
            keysignPayload.blockChainSpecific as? BlockChainSpecific.THORChain
        ...
        val fromAddress =
            AnyAddress(thorChainSwapPayload.srcToken.address, CoinType.THORCHAIN).data()
                ...
                .apply {
                    ...
                    this.fee =
                        Cosmos.Fee.newBuilder()
                            .apply { this.gas = ThorChainHelper.THOR_CHAIN_GAS_UNIT }
                            .build()
